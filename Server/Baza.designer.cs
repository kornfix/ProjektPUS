...
namespace Server
{
    ...
    partial void Deleteuzytkownicy(uzytkownicy instance);
		...
		public BazaDataContext() : 
				base(global::Server.Properties.Settings.Default.bazaDanychConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<plansze> planszes
		{
			get
			{
		...
		public System.Data.Linq.Table<rozgrywki> rozgrywkis
		{
			get
			{
		...
		public System.Data.Linq.Table<ruchy_graczy> ruchy_graczies
		{
			get
			{
    ...
    partial void Onnazwa_paneluChanging(string value);
    partial void Onnazwa_paneluChanged();
    ...
    partial void Onid_gryChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_nazwa_panelu", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string nazwa_panelu
		{
			get
			{
				return this._nazwa_panelu;
			}
			set
			{
				if ((this._nazwa_panelu != value))
				{
					this.Onnazwa_paneluChanging(value);
					this.SendPropertyChanging();
					this._nazwa_panelu = value;
					this.SendPropertyChanged("nazwa_panelu");
					this.Onnazwa_paneluChanged();
				}
			}
		}
			...
			set
			{
							...
							|| (this._rozgrywki.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.planszes.Remove(this);
					}
					this._rozgrywki.Entity = value;
					if ((value != null))
					{
						value.planszes.Add(this);
	...
	public partial class rozgrywki : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<plansze> _planszes;
		
		private EntitySet<ruchy_graczy> _ruchy_graczies;
    ...
    partial void Onid_gracza_nr_dwaChanged();
		...
		public rozgrywki()
		{
			this._planszes = new EntitySet<plansze>(new Action<plansze>(this.attach_planszes), new Action<plansze>(this.detach_planszes));
			this._ruchy_graczies = new EntitySet<ruchy_graczy>(new Action<ruchy_graczy>(this.attach_ruchy_graczies), new Action<ruchy_graczy>(this.detach_ruchy_graczies));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="rozgrywki_plansze", Storage="_planszes", ThisKey="id_gry", OtherKey="id_gry")]
		public EntitySet<plansze> planszes
		{
			get
			{
				return this._planszes;
			}
			set
			{
				this._planszes.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="rozgrywki_ruchy_graczy", Storage="_ruchy_graczies", ThisKey="id_gry", OtherKey="id_gry")]
		public EntitySet<ruchy_graczy> ruchy_graczies
		{
			get
			{
				return this._ruchy_graczies;
			}
			set
			{
				this._ruchy_graczies.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="uzytkownicy_rozgrywki", Storage="_uzytkownicy", ThisKey="id_gracza_nr_jeden", OtherKey="id_uzytkownika", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._uzytkownicy.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.rozgrywkis.Remove(this);
					}
					this._uzytkownicy.Entity = value;
					if ((value != null))
					{
						value.rozgrywkis.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="uzytkownicy_rozgrywki1", Storage="_uzytkownicy1", ThisKey="id_gracza_nr_dwa", OtherKey="id_uzytkownika", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._uzytkownicy1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.rozgrywkis1.Remove(this);
					}
					this._uzytkownicy1.Entity = value;
					if ((value != null))
					{
						value.rozgrywkis1.Add(this);
		...
		private void attach_planszes(plansze entity)
		{
			this.SendPropertyChanging();
			entity.rozgrywki = this;
		}
		
		private void detach_planszes(plansze entity)
		{
			this.SendPropertyChanging();
			entity.rozgrywki = null;
		}
		
		private void attach_ruchy_graczies(ruchy_graczy entity)
		{
			this.SendPropertyChanging();
			entity.rozgrywki = this;
		}
		
		private void detach_ruchy_graczies(ruchy_graczy entity)
		{
			this.SendPropertyChanging();
			entity.rozgrywki = null;
		}
    ...
    partial void OnruchChanging(int value);
    ...
    partial void Onid_gryChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ruch", DbType="Int NOT NULL")]
		public int ruch
		{
			get
			{
		...
		public rozgrywki rozgrywki
		{
			...
			set
			{
							...
							|| (this._rozgrywki.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._rozgrywki.Entity = null;
						previousValue.ruchy_graczies.Remove(this);
					}
					this._rozgrywki.Entity = value;
					if ((value != null))
					{
						value.ruchy_graczies.Add(this);
						this._id_gry = value.id_gry;
					}
					else
					{
	...
	public partial class uzytkownicy : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<rozgrywki> _rozgrywkis;
		
		private EntitySet<rozgrywki> _rozgrywkis1;
    ...
    partial void OnhasloChanged();
		...
		public uzytkownicy()
		{
			this._rozgrywkis = new EntitySet<rozgrywki>(new Action<rozgrywki>(this.attach_rozgrywkis), new Action<rozgrywki>(this.detach_rozgrywkis));
			this._rozgrywkis1 = new EntitySet<rozgrywki>(new Action<rozgrywki>(this.attach_rozgrywkis1), new Action<rozgrywki>(this.detach_rozgrywkis1));
			this._ruchy_graczies = new EntitySet<ruchy_graczy>(new Action<ruchy_graczy>(this.attach_ruchy_graczies), new Action<ruchy_graczy>(this.detach_ruchy_graczies));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="uzytkownicy_rozgrywki", Storage="_rozgrywkis", ThisKey="id_uzytkownika", OtherKey="id_gracza_nr_jeden")]
		public EntitySet<rozgrywki> rozgrywkis
		{
			get
			{
				return this._rozgrywkis;
			}
			set
			{
				this._rozgrywkis.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="uzytkownicy_rozgrywki1", Storage="_rozgrywkis1", ThisKey="id_uzytkownika", OtherKey="id_gracza_nr_dwa")]
		public EntitySet<rozgrywki> rozgrywkis1
		{
			get
			{
				return this._rozgrywkis1;
			}
			set
			{
				this._rozgrywkis1.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="uzytkownicy_ruchy_graczy", Storage="_ruchy_graczies", ThisKey="id_uzytkownika", OtherKey="id_gracza")]
		public EntitySet<ruchy_graczy> ruchy_graczies
		{
			get
			{
		...
		private void attach_rozgrywkis(rozgrywki entity)
		{
			this.SendPropertyChanging();
			entity.uzytkownicy = this;
		}
		
		private void detach_rozgrywkis(rozgrywki entity)
		{
			this.SendPropertyChanging();
			entity.uzytkownicy = null;
		}
		
		private void attach_rozgrywkis1(rozgrywki entity)
		{
			this.SendPropertyChanging();
			entity.uzytkownicy1 = this;
		}
		
		private void detach_rozgrywkis1(rozgrywki entity)
		{
			this.SendPropertyChanging();
